...
def test_mapwidget_copy_position_at_point_builds_expected_js_call():
    ...
    js, world_id, callback = page.runJavaScript.call_args.args
...
def test_mapwidget_copy_result_ignores_wrong_length_payload(qapp):
    dummy = type("DummyMap", (), {"_position": (4.0, 5.0), "_logger": None})()

    MapWidget._on_copy_position_result(dummy, "no-comma-here")
