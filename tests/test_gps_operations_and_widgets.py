...
def test_mapwidget_copy_result_updates_position_and_clipboard(qapp):
    dummy = type("DummyMap", (), {"_position": (0.0, 0.0), "_logger": None, "copy_position": MagicMock()})()
...
def test_mapwidget_copy_result_invalid_payload_keeps_position(qapp):
    dummy = type("DummyMap", (), {"_position": (9.0, 8.0), "_logger": None})()

    MapWidget._on_copy_position_result(dummy, "x,notanumber")
